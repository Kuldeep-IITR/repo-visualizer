  ...
  return (
    <Modal title="How to read the map" onClose={onClose} width={640}>
      <section className="help">
        ...
        <ul>
          <li><b>Paste a GitHub URL</b> in the path box to analyse a public repository. It is downloaded once and reused; the ↻ button next to its name fetches the latest commit and 🗑 deletes the download. The welcome screen lists everything downloaded so far.</li>
